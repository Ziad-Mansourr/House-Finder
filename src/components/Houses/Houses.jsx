      ...
      <div className="col-span-12 md:col-span-7">
        ...
        <div className=" shadow-md flex-wrap bg-[rgb(249,249,249)] flex  mb-10  ">
          <div className="lg:w-[40%] h-[340px] w-[100%] ">
            <Slider {...settings}>
              <div>
                <img className="w-full h-[300px]" src="Collage/h1.jpg" alt="" />
              </div>
              <div>
                <img
                  className="w-full h-[300px] "
              ...
              <div>
                <img className="w-full h-[300px]" src="Collage/h3.jpg" alt="" />
              </div>
              <div>
                <img className="w-full h-[300px]" src="Collage/h1.jpg" alt="" />
              </div>
              <div>
                <img className="w-full h-[300px]" src="Collage/h2.jpg" alt="" />
              </div>
            </Slider>
          </div>
          <div className="  ml-10  flex flex-col  justify-center">
